...
start_qemu() {
	qemu-system-arm -M versatilepb -cpu arm1176 -m 256 -hda "$DETECTED_SYSIMG" -kernel /qemu/kernel-qemu -append "root=$APPENDED_ROOTDEVICE $ADDITIONAL_BOOTPARAMS" -vnc 0.0.0.0:1
}
